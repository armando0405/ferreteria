...
public class VentanaPrincipal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(b_clientes, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 280, 200, 80));
        ...
        getContentPane().add(b_productos, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 280, 200, 80));
        ...
        getContentPane().add(b_ventas, new org.netbeans.lib.awtextra.AbsoluteConstraints(540, 280, 200, 80));
        ...
        getContentPane().add(b_almacen, new org.netbeans.lib.awtextra.AbsoluteConstraints(770, 280, 200, 80));
        ...
        getContentPane().add(b_salir, new org.netbeans.lib.awtextra.AbsoluteConstraints(870, 420, 120, 45));

        copy.setText("famaCorporation System  ©");
        getContentPane().add(copy, new org.netbeans.lib.awtextra.AbsoluteConstraints(420, 440, 166, -1));
        ...
        getContentPane().add(b_email, new org.netbeans.lib.awtextra.AbsoluteConstraints(850, 180, 120, 45));
        ...
        getContentPane().add(b_volver, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 420, 120, 45));

        l_fondo.setIcon(new javax.swing.ImageIcon(getClass().getResource("/ventanas/fondo_principal.jpg"))); // NOI18N
        getContentPane().add(l_fondo, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 1010, 480));
